...
/* HC5761 keeps OEM, board-info and backup data at the end of its flash. */
#if defined(HC5761_BOARD)
#define CFG_FIRMWARE_TRAILING_RESERVED_SIZE	0x40000
#define CFG_HC5761_BDINFO_OFFSET		0xFE0000
#define CFG_HC5761_MAC_OFFSET		0x18A
#define CFG_HC5761_MAC_ASCII_LEN		17
#else
#define CFG_FIRMWARE_TRAILING_RESERVED_SIZE	0x00000
#endif

#define CFG_FIRMWARE_TOTAL_RESERVED_SIZE	(CFG_FIRMWARE_RESERVED_SIZE + \
					 CFG_FIRMWARE_TRAILING_RESERVED_SIZE)
...
#if defined (ON_BOARD_2M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x100000 - CFG_FIRMWARE_TOTAL_RESERVED_SIZE)
#elif defined (ON_BOARD_4M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x200000 - CFG_FIRMWARE_TOTAL_RESERVED_SIZE)
#elif defined (ON_BOARD_8M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x400000 - CFG_FIRMWARE_TOTAL_RESERVED_SIZE)
#elif defined (ON_BOARD_16M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x800000 - CFG_FIRMWARE_TOTAL_RESERVED_SIZE)
#endif
...
#define CFG_KERN_SIZE		(0x800000 - CFG_FIRMWARE_TOTAL_RESERVED_SIZE)
#elif defined ( ON_BOARD_16M_FLASH_COMPONENT )
#define CFG_KERN_SIZE		( 0x1000000 - CFG_FIRMWARE_TOTAL_RESERVED_SIZE )
#endif
#endif
