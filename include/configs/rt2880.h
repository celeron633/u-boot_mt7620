...
#if defined(PSG1218_BOARD) || defined(YK_L1_BOARD) || defined(HC5761_BOARD)
...
#define CFG_KERN_ADDR		(CFG_FLASH_BASE + CFG_FIRMWARE_RESERVED_SIZE)
#elif defined ( ON_BOARD_32M_FLASH_COMPONENT ) && !defined ( DUAL_IMAGE_SUPPORT )
...
#define CFG_KERN_ADDR		(CFG_FLASH_BASE + CFG_FIRMWARE_RESERVED_SIZE)
#ifdef DUAL_IMAGE_SUPPORT
#define CFG_KERN2_ADDR		(CFG_FLASH2_BASE + CFG_FIRMWARE_RESERVED_SIZE)
#endif
#endif

#if defined(PSG1218_V225_LAYOUT)
#define CFG_PERMANENT_CONFIG_SIZE	0x50000
#else
#define CFG_PERMANENT_CONFIG_SIZE	0x00000
#endif

#define CFG_FIRMWARE_RESERVED_SIZE	(CFG_BOOTLOADER_SIZE + CFG_CONFIG_SIZE + \
					 CFG_FACTORY_SIZE + CFG_PERMANENT_CONFIG_SIZE)

/* HC5761 board-info contains the factory MAC address as ASCII text. */
#if defined(HC5761_BOARD)
#define CFG_HC5761_BDINFO_OFFSET		0xFE0000
#define CFG_HC5761_MAC_OFFSET		0x18A
#define CFG_HC5761_MAC_ASCII_LEN		17
#endif
...
#if defined (ON_BOARD_2M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x100000 - CFG_FIRMWARE_RESERVED_SIZE)
#elif defined (ON_BOARD_4M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x200000 - CFG_FIRMWARE_RESERVED_SIZE)
#elif defined (ON_BOARD_8M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x400000 - CFG_FIRMWARE_RESERVED_SIZE)
#elif defined (ON_BOARD_16M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x800000 - CFG_FIRMWARE_RESERVED_SIZE)
#endif
#define CFG_KERN2_SIZE		CFG_KERN_SIZE
#else // Non Dual Image
#if defined(HC5761_BOARD)
#define CFG_KERN_SIZE		0xF70000
#elif defined (ON_BOARD_2M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x200000 - CFG_FIRMWARE_RESERVED_SIZE)
#elif defined (ON_BOARD_4M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x400000 - CFG_FIRMWARE_RESERVED_SIZE)
#elif defined (ON_BOARD_8M_FLASH_COMPONENT)
#define CFG_KERN_SIZE		(0x800000 - CFG_FIRMWARE_RESERVED_SIZE)
#elif defined ( ON_BOARD_16M_FLASH_COMPONENT )
#define CFG_KERN_SIZE		( 0x1000000 - CFG_FIRMWARE_RESERVED_SIZE )
#elif defined ( ON_BOARD_32M_FLASH_COMPONENT )
#define CFG_KERN_SIZE		( 0x2000000 - CFG_FIRMWARE_RESERVED_SIZE )
#endif
#endif
...
#if defined(HC5761_BOARD)
#define WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES	( 576 * 1024 )
#elif defined(PSG1218_V225_LAYOUT)
#define WEBFAILSAFE_UPLOAD_LIMITED_AREA_IN_BYTES	( 640 * 1024 )
#else
